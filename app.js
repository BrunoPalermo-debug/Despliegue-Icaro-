...
if (total === 0) {
  resumen.innerHTML = `<div class="alert alert-warning">Seleccioná al menos un componente</div>`;
  return;
}
// BOTÓN
...
const builds = [
  {
    ...
    imagen: "./BY2AS2506020HVODE3F.webp",
  },
  {
    nombre: "PC Gamer RGB Gama Alta",
    descripcion: "Ryzen 9 + RX 7700 XT",
    imagen: "./supreme-7950x-e-4070-ti.webp",
  },
  {
    nombre: "PC Gamer RGB Gama Ultra!",
    descripcion: "Ryzen 7 + RTX 4090",
    imagen:
      "./Hyper-Cyber-Ultra-X-AMD-Ryzen-7-9800X3D-NVIDIA-GeForce-RTX-4090-Gaming-PC_638282b0-e5eb-4c2f-8b08-68f154ad6cd9.902c437fb34e59125fa1a29180e91d48.webp",
  },
];
